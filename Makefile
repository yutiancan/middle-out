...
test:
	$(CC) -std=c++14 -o $(TEST_TARGET) $(TEST_OBJECTS) $(CC_TEST_FLAGS)  $(LD_TEST_FLAGS) \
	&& ./$(TEST_TARGET)

test-avx512:
	$(CC) -std=c++14 -o $(TEST_TARGET) $(TEST_OBJECTS) avx512.cpp $(CC_TEST_FLAGS) \
...
lib:
	mkdir -p $(BUILD_DIR)
	$(CC) -std=c++14 $(CC_LIB_FLAGS) middleout.cpp scalar.cpp helpers.hpp -march=native
...
lib-avx512:
	mkdir -p $(BUILD_DIR)
	$(CC) -std=c++14 $(CC_LIB_FLAGS) middleout.cpp avx512.cpp helpers.hpp -march=skylake-avx512 -D USE_AVX512
...
###
CC_GBENCH_FLAGS = -O3 -g -Wall -MMD -std=c++14
...
bench:
	$(CC) -std=c++14 -Wc++14-compat -o $(GBENCH_TARGET) $(GBENCH_OBJECTS) $(CC_GBENCH_FLAGS) -march=native $(LD_GBENCH_FLAGS)
	./$(GBENCH_TARGET)

bench-avx512:
	$(CC) -std=c++14 -Wc++14-compat -o $(GBENCH_TARGET) $(GBENCH_OBJECTS) avx512.cpp $(CC_GBENCH_FLAGS) -march=skylake-avx512 $(LD_GBENCH_FLAGS) -D USE_AVX512
	./$(GBENCH_TARGET)
